...
var app, imagesContainer, imagesColorMatrix, ticker,
...
settings={
	...
	setScene = function(){
		...
		domRefs.$stageContainer.appendChild(app.view);
		domRefs.$stageContainer.style.cursor="pointer";
	...
	drawRandomLines=function(){
		...
		linesOverlay.bezierCurveTo(
			...
			domRefs.$stageContainer.addEventListener("click", changeNegativeMode);
			domRefs.$stageContainer.addEventListener("touchstart", changeNegativeMode);
