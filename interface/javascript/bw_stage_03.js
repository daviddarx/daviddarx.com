...
- faire include html pour les favicon! 



- check plugin posthtml

- faire $domrefs exports? ou en return de int. 
- fixe le inner html

_ remplacer touch start par pointer events. 
- check probleme des avertissement des images caches id. 


- ajouter le eslint rc dans boilerplate. 

- separer les html et faire des html include avec parcel. 
- virer tous les ids mettre des classes
...
- mettre window size dan retirzn de init pluto que variable sur window. 
*/
